                    ...
                    <div className="box two">
                        ...
                        <div className="form">
                            <form action="dodaj.php" method="POST">
                                ...
                                <p>Hasło</p>
                                <ShowPassword />
                                <div className="linkPassword"><a href="" target="_blank" rel="noopener noreferrer">Nie pamiętasz hasła?<i className="arrow"></i></a></div>
                                <div className="btnBox"><button type="submit" className="btn">Zaloguj się</button></div>
                            </form>
                            <div className="btnBox2"><button type="submit" className="btn">Nie mam konta</button></div>
                        </div>
                    </div>
                </div>
            </div>
