        ...
        return (
            <div id="registration">
                <div className="container">
                    <div className="box">
                        <h3 class="medium">Zarejestruj się</h3>
                        <div className="form">
                    ...
                    <div className="box two">
                        ...
                        <div className="redBox">
                            ...
                            <p>Jeżeli tak, to skorzystaj z opcji <a href="">zapomniałem hasło</a> podając ten sam email. Konta na Taksidi i na The Boat Trip są połączone. Jedynie w ten sposób poprawnie naliczą Ci się zniżki lojalnościowe na Taksidi.</p>
                        </div>
                    </div>
                </div>
            </div>
